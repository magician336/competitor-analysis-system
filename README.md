...
测试还覆盖 Alembic 升降级、SQLite 外键/WAL、Manifest 导入、Pydantic 往返校验、事务回滚、异步提交、分支重试、协作式取消、租约恢复、正式 API 分页、认证、限流、审计和 Comparison 幂等。当前全项目离线回归为 `363 passed, 1 skipped`。
